    ...
    def check_in(
        ...
        *,
        ...
        AttendanceEventValidator.validate_workflow_state_transition(
            current_status, AttendanceEventTypes.CHECK_IN
        )
        
        # NEW: Simple shift time check — can't check in after shift ends
        ShiftTimeValidator.validate_check_in(company=company, membership=membership)
